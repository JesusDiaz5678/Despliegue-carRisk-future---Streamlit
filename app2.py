...
Original file is located at
    https://colab.research.google.com/drive/1Zuu0QHWYl6DeTAg1447kBvGotk8bTqu0
...
st.title('Predicción de riesgo de Carros')

Edad = st.slider('Edad', min_value=data['age'].min(), max_value=data['age'].max(), value=int(data['age'].mean()), step=1)
Cartype = st.selectbox('Tipo de carro', data['cartype'].unique())
